...
const Home = () => {
  const [bikes, setBikes] = useState([
    { id: 1, name: 'Honda CB Shine', brand: 'Honda', cc: 125, price: 350, available: true, rating: 4.5 },
    { id: 2, name: 'Yamaha FZ', brand: 'Yamaha', cc: 150, price: 400, available: true, rating: 4.6 },
    { id: 3, name: 'TVS Apache', brand: 'TVS', cc: 160, price: 380, available: false, rating: 4.3 },
    { id: 4, name: 'Royal Enfield Classic', brand: 'Royal Enfield', cc: 350, price: 1200, available: true, rating: 4.8 },
  ]);
      ...
      <div style={{ display: 'flex', gap: '8px', marginBottom: '16px', flexWrap: 'wrap' }}>
        {brands.map((brand) => (
          <button
            ...
            style={{
              padding: '6px 16px',
              background: filterBrand === brand ? '#4CAF50' : '#f0f0f0',
              color: filterBrand === brand ? 'white' : '#333',
              border: 'none',
              borderRadius: '20px',
              cursor: 'pointer',
              fontSize: '14px',
            ...
            >
              <div style={{
                ...
                <div style={{ textAlign: 'right' }}>
                  ...
                  <span style={{
                    fontSize: '12px',
                    color: bike.available ? '#4CAF50' : '#E53935',
                    fontWeight: 'bold',
                  }}>
